...
class month_sharp_simulation():
    ...
    def preprocess_data(self, pf_list):
        self.pf_list = pdata.read_pf_list(pf_list)
        profit_data = pdata.import_profit_data(self.pf_list) 
        amount_data = pdata.import_account_data(self.pf_list)           
...
class onetime_sharp_simulation():
    ...
    def simulate(self):
        self.sharp_data = sim.simulation(self.pf_list, self.log_profit_data)
        print(self.sharp_data)
        return True
